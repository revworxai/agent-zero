...
// ============================================================
// Timezone Override — America/Belize
// Prevents CRM 'Set your time zone' modal by making the
// browser's JS environment report America/Belize as the
// timezone, matching the CRM account setting.
// The CRM checks: Intl.DateTimeFormat().resolvedOptions().timeZone
// ============================================================
(function() {
    const _originalResolvedOptions = Intl.DateTimeFormat.prototype.resolvedOptions;
    Intl.DateTimeFormat.prototype.resolvedOptions = function() {
        const _opts = _originalResolvedOptions.call(this);
        _opts.timeZone = 'America/Belize';
        return _opts;
    };
    // Also override the constructor to set timezone_id by default
    const _OrigDTF = Intl.DateTimeFormat;
    const _NewDTF = function(locale, options) {
        if (typeof options === 'object' && options !== null) {
            if (!options.timeZone) options.timeZone = 'America/Belize';
        } else if (options === undefined || options === null) {
            options = { timeZone: 'America/Belize' };
        }
    ...
    try { Intl.DateTimeFormat = _NewDTF; } catch(e) {}
})();
